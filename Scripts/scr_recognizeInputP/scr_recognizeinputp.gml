function scr_recognizeInputP(argument0) {
	switch(argument0){
	    //gamepad
	    case 32769: return "CROSS"; break;
	    case 32770: return "CIRCLE"; break;
	    case 32771: return "SQUARE"; break;
	    case 32772: return "TRIANGLE"; break;
	    ...
	    case 32778: return "START/OPTIONS"; break;
